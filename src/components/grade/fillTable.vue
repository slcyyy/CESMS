  ...
  <div>
    ...
    <el-card class ="box-card">
      ...
      <el-row style="margin-top:20px;">
        <span style="margin-right:30px;color:red;font-size:14px;">已填写:</span>
        <span style="color:green;font-size:14px;">未提交:</span>
      </el-row>
...
export default {
  ...
  methods: {
    handleChange() {
      ...
      //console.log(obj[0].parent.label,obj[0].label)
